...
func SetupRouter(userHandler user.UserHandlerInterface, teamHandler teams.TeamHandlerInterface, loginHandler login.LoginHandlerInterface) {
	router := gin.Default()

	InitializeRouters(router, userHandler, teamHandler, loginHandler)
